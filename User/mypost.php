          ...
          <div class="col-md-9" id="dprofile">
            <div class="card bg-light mb-3">
              ...
              <div>
                ...
                <div class="row mb-4">
                  <div class="col-4">
                    <img class="w-100" src="img/nature.jpg" alt="Generic placeholder image">
                  </div>
                  <div class="col-6">
                    <h5 class="mt-0 mb-1">Nature</h5>
                    <p>
                      Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla<span class="text-muted">...see more</span>
                    </p>
                  </div>
                  <div class="col-2 mt-4">
                    <p><button type="button" class="btn btn-sm btn-primary w-75"><i class="fas fa-pen"></i> View</button></p>
                    <p><button type="button" class="btn btn-sm btn-success w-75"><i class="fas fa-edit"></i> Edit</button></p>
                    <p><button type="button" class="btn btn-sm btn-danger w-75"><i class="fas fa-trash-alt"></i> Delete</button></p>
                  </div>
                </div>
